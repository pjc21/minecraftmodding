...
import pjc21.mod.objects.blocks.machines.sinterer.slots.SlotSinteringFurnaceFuel;
import pjc21.mod.objects.blocks.machines.sinterer.slots.SlotSinteringFurnaceOutput;
...
public class ContainerSinteringFurnace extends Container
{
	...
	public ContainerSinteringFurnace(InventoryPlayer player, TileEntitySinteringFurnace tileentity) 
	{
		...
		this.addSlotToContainer(new SlotSinteringFurnaceFuel(tileentity, 2, 56, 53));
		this.addSlotToContainer(new SlotSinteringFurnaceOutput(player.player, tileentity, 3, 116, 35));
	...
	public void addListener(IContainerListener listener) 
	{
		...
		listener.sendAllWindowProperties(this, this.titeentity);
	}
