...
public class TileEntitySinteringFurnace extends TileEntity implements IInventory, ITickable
{
	...
	public void readFromNBT(NBTTagCompound compound) 
	{
		...
		System.out.println("TileEntity ReadNBT - Compound1" + compound.toString());
		System.out.println("TileEntity ReadNBT - BurnTime" + this.burnTime);
		System.out.println("TileEntity ReadNBT - CookTime" + this.cookTime);
		System.out.println("TileEntity ReadNBT - TotalCookTime" + this.totalCookTime);
	...
	public NBTTagCompound writeToNBT(NBTTagCompound compound) 
	{
		...
		System.out.println("TileEntity WriteNBT - Compound1" + compound.toString());
		System.out.println("TileEntity WriteNBT - BurnTime" + this.burnTime);
		System.out.println("TileEntity WriteNBT - CookTime" + this.cookTime);
		System.out.println("TileEntity WriteNBT - TotalCookTime" + this.totalCookTime);
		return compound;
	}
