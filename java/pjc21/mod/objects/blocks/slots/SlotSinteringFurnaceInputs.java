...
public class SlotSinteringFurnaceInputs extends SlotItemHandler
{
	public SlotSinteringFurnaceInputs(IItemHandler itemHandler, int index, int xPosition, int yPosition) 
	{
